 ...
 * @author Hoang
 */
public class CT_HD_BH extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_HD_BH.getData1();
    ...
    public CT_HD_BH() {
        ...
        txt_Ma_HD_BH.setText(Save_Ma_NV.getMa_HD_BH_1());
        Load();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, -4, -1, 60));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 940, 330));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 500, -1, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 240, 40));
        ...
        getContentPane().add(txt_Tong_DT, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 430, 450, -1));
