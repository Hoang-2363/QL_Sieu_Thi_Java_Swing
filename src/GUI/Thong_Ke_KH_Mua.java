 ...
 * @author Hoang
 */
public class Thong_Ke_KH_Mua extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_TKe_$_BH.TK_KH();
    ...
    private void initComponents() {
        ...
        setTitle("Thống kê khách hàng mua ");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Sitka Subheading", 3, 36)); // NOI18N
        jLabel1.setText("Thống kê khách hàng mua hàng");
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 440, 130, 40));
        ...
        getContentPane().add(txt_Tong_DT, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 440, 450, -1));
        ...
        getContentPane().add(btn_Xem_CT, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 500, -1, -1));
        ...
        getContentPane().add(btn_Thoat, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 500, -1, -1));
    ...
    private void btn_Xem_CTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Xem_CTActionPerformed
        ...
        if(txt_SDT.getText().equals("")){
            ...
            Thong_Ke_KH_Mua_HD menu = new Thong_Ke_KH_Mua_HD();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Ke_KH_Mua().setVisible(true);
            }
        });
    }
