 ...
 * @author Hoang
 */
public class QL_HD_NH extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_HD_Nhap_H.getData();
    ...
    private void initComponents() {
        ...
        setTitle("Quản lý hóa đơn nhập hàng");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setFont(new java.awt.Font("Sitka Subheading", 3, 36)); // NOI18N
        jLabel3.setText("Quản lý hóa đơn nhập hàng");
        ...
        getContentPane().add(txt_Ma_HD_BH, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 140, -1));
    ...
    private void table_HHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_HHMouseClicked
        ...
        if (i != -1) {
            ...
            String gio = table_HH.getValueAt(i, 4).toString();
            String ngay = table_HH.getValueAt(i, 5).toString();

            txt_Ma_HD_BH.setText(mhd_bh);
            txt_Gio.setText(gio);
            txt_Ngay.setText(ngay);

            Save_Ma_NV.setMa_nhap_hang_1(txt_Ma_HD_BH.getText());
        }
