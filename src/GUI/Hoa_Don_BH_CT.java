 ...
 * @author Hoang
 */
public class Hoa_Don_BH_CT extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_HD_BH.getData3();
        table_DAT_HH.setModel(tableModel);
        table_DAT_HH.setRowHeight(30);
        table_DAT_HH.getColumnModel().getColumn(0).setPreferredWidth(300);
        table_DAT_HH.getColumnModel().getColumn(1).setPreferredWidth(80);
        ...
        table_DAT_HH.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
    ...
    public Hoa_Don_BH_CT() {
        initComponents();
        this.setLocationRelativeTo(null);
        TableCellRenderer rendererFromHeader = table_DAT_HH.getTableHeader().getDefaultRenderer();
        JLabel headerLabel = (JLabel) rendererFromHeader;
        headerLabel.setHorizontalAlignment(JLabel.CENTER);
        
        Connect_HD_BH.Load_TT(txt_Ma_HD_BH, txt_Thoi_Gian_TT, txt_Ten_Nv, txt_Ten_KH, txt_SDT, txt_Dia_Chi);
        Load();
        Tong_HD(table_DAT_HH, txt_Tong_DT);
    ...
    private void initComponents() {
        ...
        setTitle("Hóa đơn bán hàng chi tiết");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setFont(new java.awt.Font("Sitka Subheading", 3, 36)); // NOI18N
        jLabel3.setText("Hóa đơn bán hàng chi tiết");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, -10, -1, 80));
        ...
        getContentPane().add(txt_Ma_HD_BH, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 60, 250, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 550, 90, 30));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setText("Mã HD bán hàng");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, -1, 30));
        ...
        getContentPane().add(txt_Thoi_Gian_TT, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 250, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setText("Thời gian thanh toán");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, 30));
        ...
        getContentPane().add(txt_Ten_Nv, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 250, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setText("Tên nhân viên");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, -1, 30));
        ...
        getContentPane().add(txt_Ten_KH, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 60, 250, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel9.setText("Tên khách hàng");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 60, -1, 30));
        ...
        getContentPane().add(txt_SDT, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 120, 250, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel10.setText("SĐT");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 120, -1, 30));
        ...
        getContentPane().add(txt_Dia_Chi, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 170, 250, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel11.setText("Địa chỉ");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 170, -1, 30));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 550, -1, -1));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hoa_Don_BH_CT().setVisible(true);
            }
        });
    }
