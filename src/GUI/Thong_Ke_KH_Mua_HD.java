 ...
 * @author Hoang
 */
public class Thong_Ke_KH_Mua_HD extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_TKe_$_BH.TK_HD_Theo_KH();
    ...
    private void initComponents() {
        ...
        setTitle("Hóa đơn của khách hàng");
    ...
    private void btn_ThoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ThoatActionPerformed
        ...
        Thong_Ke_KH_Mua menu = new Thong_Ke_KH_Mua();
    ...
    private void btn_XemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_XemActionPerformed
        ...
        if (kt) {
            KT_Thong_Ke.TK_TK_KH(table_HH, s, e, t);
            Tong_HD(table_HH, txt_Tong_DT);
        } else {
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Ke_KH_Mua_HD().setVisible(true);
            }
        });
    }
