 ...
 * @author Hoang
 */
public class Thong_Ke_$_NH_TNgay extends javax.swing.JFrame {
    
    public void Load() {
        DefaultTableModel tableModel = Connect_Tke_$_NH.TK_Theo_Ngay();
        ...
        table_HH.getColumnModel().getColumn(2).setPreferredWidth(130);
    ...
    private void initComponents() {
        ...
        setTitle("Thống kê nhập hàng theo ngày");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setFont(new java.awt.Font("Sitka Subheading", 3, 36)); // NOI18N
        jLabel3.setText("Chi tiết hóa đơn nhập hàng");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 6, -1, 50));
        ...
        getContentPane().add(txt_Ngay, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 60, 230, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Thong_Ke_$_NH menu = new Thong_Ke_$_NH();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Ke_$_NH_TNgay().setVisible(true);
            }
        });
    }
