 ...
 * @author Hoang
 */
public class Thong_Ke_HH_So_Luong_B extends javax.swing.JFrame {
    public void Load() {
        DefaultTableModel tableModel = Connect_TKe_$_BH.TK_HH_Ban();
    ...
    private void initComponents() {
        ...
        setTitle("Thống kê hàng hóa đã bán");
        ...
        jLabel1.setText("Danh sách hàng hóa đã bán");
        ...
        getContentPane().add(txt_So_Luong, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 60, 140, -1));
    ...
    private void btn_XemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_XemActionPerformed
        ...
        if (kt) {
            if (txt_Tim_Theo.getSelectedItem().equals("Tên hàng hóa")) {
                Connect_TKe_$_BH.Tim_kiem_Theo_Ngay_Ten(table_HH3, s, e);
            } else if (txt_Tim_Theo.getSelectedItem().equals("Nhà cung cấp")) {
                Connect_TKe_$_BH.Tim_kiem_Theo_ngay_NCC(table_HH3, s, e);

            } else if (txt_Tim_Theo.getSelectedItem().equals("Loại hàng hóa")) {
                Connect_TKe_$_BH.Tim_kiem_Theo_ngay_LHH(table_HH3, s, e);
            }
        } else {
        }
    ...
    private void txt_Tim_TheoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_Tim_TheoActionPerformed
        ...
        if (txt_Tim_Theo.getSelectedItem().equals("Tên hàng hóa")) {
            ...
            txt_Ten_HH.setText("");
            txt_So_Luong.setText("");
            Connect_TKe_$_BH.TK_HH_Ban_Nha_Cung_Cap(table_HH3);
        } else if (txt_Tim_Theo.getSelectedItem().equals("Loại hàng hóa")) {
            txt_Ten_HH.setText("");
            txt_So_Luong.setText("");
            Connect_TKe_$_BH.TK_HH_Ban_LHH(table_HH3);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Ke_HH_So_Luong_B().setVisible(true);
            }
        });
    }
