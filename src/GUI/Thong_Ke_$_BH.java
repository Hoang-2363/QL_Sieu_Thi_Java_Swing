 ...
 * @author Hoang
 */
public class Thong_Ke_$_BH extends javax.swing.JFrame {

    public void Load() {
        DefaultTableModel tableModel = Connect_TKe_$_BH.TH_BH();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 870, 230));
    ...
    private void btn_XemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_XemActionPerformed
        ...
        if (kt) {
            KT_Thong_Ke.TK_TK(table_HH, s, e);
            Tong_HD(table_HH, txt_Tong_DT);
        } else {
        }
    ...
    private void btn_Xem_CTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Xem_CTActionPerformed
        ...
        if(txt_Ngay.getText().equals("")){
            ...
            Thong_Ke_$_BH_TNgay menu = new Thong_Ke_$_BH_TNgay();
            menu.setVisible(true);
            this.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Ke_$_BH().setVisible(true);
            }
        });
    }
